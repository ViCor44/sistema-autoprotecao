...
<section class="page-shell page-shell--narrow tipo-equipamento-editar-page">
    <header class="page-hero compact">
        <div>
            <span class="page-hero__eyebrow">Editar Tipo de Equipamento</span>
            <h1><i class="bi bi-pencil"></i> <?php echo htmlspecialchars($tipo['nome'] ?? '', ENT_QUOTES, 'UTF-8'); ?></h1>
            <p>Atualize as informações deste tipo de equipamento.</p>
        </div>
        <div class="page-hero__actions">
            <a href="index.php?controler=tipo_equipamento&acao=ver&id=<?php echo (int)$tipo['id']; ?>" class="btn btn-secondary">
    ...
    <section class="panel-surface">
        ...
        <form method="POST" action="index.php?controler=tipo_equipamento&acao=atualizar&id=<?php echo (int)$tipo['id']; ?>" class="modern-form">
            <div class="form-group">
                <label for="nome" class="form-label">Nome do Tipo <span class="required">*</span></label>
                <input type="text" id="nome" name="nome" class="form-control" 
                    value="<?php echo htmlspecialchars($tipo['nome'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
            ...
            <div class="form-group">
                ...
                <textarea id="descricao" name="descricao" class="form-control" rows="4"
                    placeholder="Descrição detalhada do tipo de equipamento..."><?php echo htmlspecialchars($tipo['descricao'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            ...
            <div class="form-row">
                    ...
                    <select id="icone" name="icone" class="form-select">
                        <?php foreach ($icones as $valor => $label): ?>
                            <option value="<?php echo htmlspecialchars($valor, ENT_QUOTES, 'UTF-8'); ?>" 
                                <?php echo ($tipo['icone'] ?? 'bi-tools') === $valor ? 'selected' : ''; ?>>
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="text" id="prefixo_numeracao" name="prefixo_numeracao" class="form-control" 
                        value="<?php echo htmlspecialchars($tipo['prefixo_numeracao'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="number" id="frequencia_inspecao" name="frequencia_inspecao" class="form-control" 
                        value="<?php echo (int)($tipo['frequencia_inspecao'] ?? 0) > 0 ? (int)$tipo['frequencia_inspecao'] : ''; ?>"
