<section class="page-shell page-shell--narrow">
    <div class="page-hero compact">
        <div>
            <span class="page-hero__eyebrow">Novo documento</span>
            <h1><i class="bi bi-file-earmark-plus"></i> Novo relatório</h1>
            <p>Crie um relatório manual quando não nascer automaticamente a partir de uma inspeção programada.</p>
        </div>
    </div>
